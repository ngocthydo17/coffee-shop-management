...
namespace Manage_Coffee.Areas.Admin.Controllers
{
    ...
    public class ThongKeTongController : Controller
    {
        ...
        public IActionResult Index(string loaiThongKe = "nam", int? nam = null, DateTime? tuNgay = null, DateTime? denNgay = null, string loaiBanHang = "all", string? selectedLabel = null, string maCN = "CN001")
        {
           ...
           // ViewBag.DanhSachChiNhanh = new SelectList(danhSachChiNhanh, "MaCn", "Ten",maCN);
            ...
            {
                var salesData = GetSalesByTime(maCN,selectedLabel, loaiThongKe, loaiBanHang);
        ...
        public JsonResult GetSalesByTime(string maCN, string time, string timeType, string hinhthuc)
        {
